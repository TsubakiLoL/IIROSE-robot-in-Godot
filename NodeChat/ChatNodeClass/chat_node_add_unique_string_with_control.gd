extends ChatNode
class_name ChatNodeAddUniqueStringWithControl
...
func process_input(id:String):
	if input_port_data[0] is bool and input_port_data[0] and input_port_data[1] is String and root!=null:
		root.add_string("main",num_name,input_port_data[1])
	pass
